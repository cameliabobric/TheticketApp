...
class AdminService(private val machine: TicketMachine) {
     ...
     * Requirement: e) Admin user should be able to change the details of an existing destination
     */
    ...
    /**
     * Adjust all ticket prices by a factor
     * Requirement: f) Admin user should be able to change all ticket prices by a certain factor
     */
    fun adjustAllPrices() {
        ConsoleUI.showMessage("\n=== ADJUST ALL PRICES ===")
